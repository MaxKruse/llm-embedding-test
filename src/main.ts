...
await openai.AddTestEmbedding({
  information: "The user plays balatro.",
  metaData: {
    type: "games",
  },
});
...
await openai.AddTestEmbedding({
  information: "The user plays Captain of Industry, a city builder.",
  metaData: {
    type: "games",
  },
});
...
await openai.AddTestEmbedding({
  information: "The user plays Helldivers 2, an extraction shooter.",
  metaData: {
    type: "games",
  },
});
...
await openai.AddTestEmbedding({
  information: "The user plays Brotato, an indie roguelike.",
  metaData: {
    type: "games",
  },
});
...
await openai.AddTestEmbedding({
  information: "The user plays Farlight 84, a battle royale.",
  metaData: {
    type: "games",
  },
});
